...
<details><summary><h5>Заметки<h5></summary>
	Бесплатные службы шрифтов, такие как Google Fonts 
	[Google Fonts](https://fonts.google.com/).
	и Adobe Fonts , размещают шрифты, на которые вы можете ссылаться из своего HTML-документа с помощью предоставленного <link>элемента.
