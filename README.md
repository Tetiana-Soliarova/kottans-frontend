...
Git commit -a не работает с новыми файлами, потому что они не отслеживаются.Вместо этого git commit -a - это ярлык для выполнениялюбых изменений в отслеживаемых файлах и фиксации их за один шаг.Если измененный файлникогда не был зафиксирован в репо,нам все равно нужно будет использовать git add, чтобы отслеживать его сначала. Эти ярлыки полезны при внесении небольших изменений, которые мы знаем, что мы хотим, чтобы зафиксировали непосредственно, не сохраняя их в промежуточной области и необходимости писать длинные и сложные описания. Имейте в виду, что когда вы используете ярлык -m, вы можете писать только короткие сообщения и не можете использовать лучшие практики в отношении описаний commit, о которых мы говорили ранее.
