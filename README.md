...
Git — это бесплатная система с открытым исходным кодом, доступная для установки на Unix платформах, Windows и macOS. Linus изначально созданный получить помощь в управлении задачей разработки ядра Linux.
